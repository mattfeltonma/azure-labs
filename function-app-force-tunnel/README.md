# Azure Function App Virtual Network Integration and Forced Tunneling
...
![lab image](https://github.com/mattfeltonma/azure-labs/blob/master/function-app-force-tunnel/lab_visual.jpeg)

## Installation
1.  Create a resource group.
2.  Deploy the template to the resource group using the New-AzResourceGroupDeployment cmdlet.  Example: **New-AzResourceGroupDeployment -Name "myDeployment" -ResourceGroupName "myResourceGroup" -TemplateUri "https://raw.githubusercontent.com/mattfeltonma/azure-labs/master/function-app-force-tunnel/deploy.json"**  
